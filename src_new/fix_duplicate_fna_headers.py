...
dataset = 'splice_sites_donors'

# Define the path to the original and the new file
original_test_fna_path = "./data/nucleotide_transformer_downstream_tasks/" + dataset + "/test.fna"
fixed_test_fna_path = "./data/nucleotide_transformer_downstream_tasks/" + dataset + "/test.fna"

original_train_fna_path = "./data/nucleotide_transformer_downstream_tasks/" + dataset + "/train.fna"
fixed_train_fna_path = "./data/nucleotide_transformer_downstream_tasks/" + dataset + "/train.fna"
