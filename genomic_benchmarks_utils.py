...
#         # dest_path="/home/wenduoc/DASH/src/data", # default for colab
#         dest_path="/home/wenduoc/ORCA/src_backup/datasets",
#         tokenizer=None,
#         tokenizer_name=None,
#         use_padding=None,
#         add_eos=False,
...
class GenomicBenchmarkDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        dataset_name='human_enhancers_cohn',
        d_output=2, # default binary classification
        dest_path='/home/wenduoc/ORCA/clean/gene-orca/datasets/genomic_benchmarks', 
        tokenizer=None,
        tokenizer_name=None,
        use_padding=None,
        add_eos=False,
